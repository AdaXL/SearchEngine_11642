...
public abstract class Qry {
    ...
    /**
     *  weight carries the weight of a Qry in WAND or WSUM operators.
     */
    ...
    public void appendArg(Qry q) throws IllegalArgumentException {
        ...
        if ((this instanceof QrySop) && (q instanceof QryIop)) {
            ...
            // Inherit the weight from inner QryIop or QrySop for WAND or WSUM operators.
    ...
    protected boolean docIteratorHasMatchFirst(RetrievalModel r) {
        ...
        // System.out.println("debug -- docIteratorHasMatchFirst: " + q_0.toString());
    ...
    protected boolean docIteratorHasMatchMin(RetrievalModel r) {
        ...
        for (int i = 0; i < this.args.size(); i++) {
            ...
            // System.out.println("debug -- docIteratorHasMatchMin: " + q_i.toString());
